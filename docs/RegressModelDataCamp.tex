...
\setlength{\droptitle}{-2em}
  \title{Online Tutorial on Regression Modeling with Actuarial and Financial
Applications}
...
\addcontentsline{toc}{subsubsection}{Video}

\paragraph{Video Overhead}\label{video-overhead}

\subparagraph{Show Overhead A. Galton's 1885 Regression
Data}\label{show-overhead-a.-galtons-1885-regression-data}
...
\subparagraph{Show Overhead B. Supporting R
Code}\label{show-overhead-b.-supporting-r-code}
...
\paragraph{Show Overhead A Details. Description of the
data}\label{show-overhead-a-details.-description-of-the-data}
...
\paragraph{Show Overhead B Details. Read and examine data
structure}\label{show-overhead-b-details.-read-and-examine-data-structure}
...
\paragraph{Show Overhead C Details. Summary stats for parents'
height}\label{show-overhead-c-details.-summary-stats-for-parents-height}
...
\paragraph{Show Overhead D. Fit a normal curve to parents' height
details}\label{show-overhead-d.-fit-a-normal-curve-to-parents-height-details}
...
\paragraph{Show Overhead E Details. Use the normal approximation to
determine the probability of the height of tall
parents}\label{show-overhead-e-details.-use-the-normal-approximation-to-determine-the-probability-of-the-height-of-tall-parents}
...
\paragraph{Show Overhead Details. Data
description}\label{show-overhead-details.-data-description}
...
\paragraph{Show Overhead A Details. Bring in Data, Introduce Logarithmic
Claims}\label{show-overhead-a-details.-bring-in-data-introduce-logarithmic-claims}
...
\paragraph{Show Overhead B Details. Show how to get a finer grid for
histograms}\label{show-overhead-b-details.-show-how-to-get-a-finer-grid-for-histograms}
...
\paragraph{Show Overhead C Details. Introduce the density
plot}\label{show-overhead-c-details.-introduce-the-density-plot}
...
\paragraph{Show Overhead A Details. Summary
statistics}\label{show-overhead-a-details.-summary-statistics}
...
\paragraph{Show Overhead B Details.
Boxplot}\label{show-overhead-b-details.-boxplot}
...
\paragraph{Show Overhead C Details. QQ
Plot}\label{show-overhead-c-details.-qq-plot}
...
\paragraph{Show Overhead A Details. Simulate a moderately skewed
distribution, with
transforms}\label{show-overhead-a-details.-simulate-a-moderately-skewed-distribution-with-transforms}
...
\paragraph{Show Overhead B Details. Visualize the
distributions}\label{show-overhead-b-details.-visualize-the-distributions}
...
\paragraph{Show Overhead A Details. Wisconsin lottery data
description}\label{show-overhead-a-details.-wisconsin-lottery-data-description}
...
\paragraph{Show Overhead B Details. Summary
statistics}\label{show-overhead-b-details.-summary-statistics}
...
\paragraph{Show Overhead C Details. Visualizing skewed
distributions}\label{show-overhead-c-details.-visualizing-skewed-distributions}
...
\paragraph{Show Overhead D Details. Visualizing relationships with a
scatter
plot}\label{show-overhead-d-details.-visualizing-relationships-with-a-scatter-plot}
...
\paragraph{Show Overhead E Details. Correlation
coefficient}\label{show-overhead-e-details.-correlation-coefficient}
...
\paragraph{Show Overhead A Details. Where to fit the
line?}\label{show-overhead-a-details.-where-to-fit-the-line}
...
\paragraph{Show Overhead B Details. Method of least
squares}\label{show-overhead-b-details.-method-of-least-squares}
...
\paragraph{Show Overhead C Details. Regression
coefficients}\label{show-overhead-c-details.-regression-coefficients}
...
\paragraph{Show Overhead D Details.
Prediction}\label{show-overhead-d-details.-prediction}
...
\paragraph{Show OverheadS A and B Details. Visualizing the uncertainty
about a
line}\label{show-overheads-a-and-b-details.-visualizing-the-uncertainty-about-a-line}
...
\paragraph{Show Overheads C, D and E Details. ANOVA
Table}\label{show-overheads-c-d-and-e-details.-anova-table}
...
\paragraph{Show Overhead A Details. Summary of basic linear regression
model}\label{show-overhead-a-details.-summary-of-basic-linear-regression-model}
...
\paragraph{Show Overhead B Details. Hypothesis
testing}\label{show-overhead-b-details.-hypothesis-testing}
...
\paragraph{Show Overhead C Details. Confidence
intervals}\label{show-overhead-c-details.-confidence-intervals}
...
\paragraph{Show Overhead D Details. Confidence intervals
check}\label{show-overhead-d-details.-confidence-intervals-check}
...
\paragraph{Show Overhead E Details. Prediction
intervals}\label{show-overhead-e-details.-prediction-intervals}
...
\paragraph{Show Overhead A Details. Unusual observations in
regression}\label{show-overhead-a-details.-unusual-observations-in-regression}
...
\paragraph{Show Overhead B Details. Example. Outliers and High Leverage
Points}\label{show-overhead-b-details.-example.-outliers-and-high-leverage-points}
...
\paragraph{Show Overhead C Details. Regression fit with 19 base
observations}\label{show-overhead-c-details.-regression-fit-with-19-base-observations}
...
\paragraph{Show Overhead D Details. Regression fit with 19 base
observations plus
C}\label{show-overhead-d-details.-regression-fit-with-19-base-observations-plus-c}
...
\paragraph{Show Overhead E Details. R
code}\label{show-overhead-e-details.-r-code}
...
\paragraph{Show Overhead F Details. Visualizing four regression
fits}\label{show-overhead-f-details.-visualizing-four-regression-fits}
...
\paragraph{Show Overhead G Details. Results from four regression
models}\label{show-overhead-g-details.-results-from-four-regression-models}
...
\paragraph{Show Overhead A Details. Demand for term life
insurance}\label{show-overhead-a-details.-demand-for-term-life-insurance}
...
\paragraph{Show Overhead B Details. Term life insurance summary
statistics}\label{show-overhead-b-details.-term-life-insurance-summary-statistics}
...
\paragraph{Show Overhead C Details. Summary
statistics}\label{show-overhead-c-details.-summary-statistics}
...
\paragraph{Show Overhead D Details. Scatter plots of income versus face
in original and logarithmic
units}\label{show-overhead-d-details.-scatter-plots-of-income-versus-face-in-original-and-logarithmic-units}
...
\paragraph{Show Overhead A Details. Correlation
table}\label{show-overhead-a-details.-correlation-table}
...
\paragraph{Show Overhead B Details. Scatterplot
matrix}\label{show-overhead-b-details.-scatterplot-matrix}
...
\paragraph{Show Overhead C Details. Visualizing a regression
plane}\label{show-overhead-c-details.-visualizing-a-regression-plane}
...
\paragraph{Show Overhead D Details. Method of least
squares}\label{show-overhead-d-details.-method-of-least-squares}
...
\paragraph{Show Overhead E Details. Fit a multiple linear regression
model}\label{show-overhead-e-details.-fit-a-multiple-linear-regression-model}
...
\paragraph{Show Overhead A Details. Goodness of
fit}\label{show-overhead-a-details.-goodness-of-fit}
...
\paragraph{Show Overhead B Details. Goodness of fit and term
life}\label{show-overhead-b-details.-goodness-of-fit-and-term-life}
...
\paragraph{Show Overhead C Details. Statistical
inference}\label{show-overhead-c-details.-statistical-inference}
...
\paragraph{Show Overhead D Details. Statistical inference and term
life}\label{show-overhead-d-details.-statistical-inference-and-term-life}
...
\paragraph{Show Overhead A Details. Binary
variables}\label{show-overhead-a-details.-binary-variables}
...
\paragraph{Show Overhead B Details. Visualize effect of binary
variables}\label{show-overhead-b-details.-visualize-effect-of-binary-variables}

\paragraph{Show Overhead C Details. R script for
visualization}\label{show-overhead-c-details.-r-script-for-visualization}
...
\paragraph{Show Overhead D Details. Interaction
Terms}\label{show-overhead-d-details.-interaction-terms}
...
\paragraph{Show Overhead E Details. Visualizing binary variables with
interactions
terms}\label{show-overhead-e-details.-visualizing-binary-variables-with-interactions-terms}
...
\paragraph{Show Overhead A Details. Categorical
variables}\label{show-overhead-a-details.-categorical-variables}
...
\paragraph{Show Overhead B Details. Term life
example}\label{show-overhead-b-details.-term-life-example}
...
\paragraph{Show Overhead C Details. Term life
boxplots}\label{show-overhead-c-details.-term-life-boxplots}
...
\paragraph{Show Overhead D Details. Regression with a categorical
variable}\label{show-overhead-d-details.-regression-with-a-categorical-variable}
...
\paragraph{Show Overhead E Details. t-ratios depend on the reference
level}\label{show-overhead-e-details.-t-ratios-depend-on-the-reference-level}
...
\paragraph{Show Overhead A Details. Testing the significance of a
categorical
variable}\label{show-overhead-a-details.-testing-the-significance-of-a-categorical-variable}
...
\paragraph{Show Overhead B Details. Overview of the general linear
hypothesis}\label{show-overhead-b-details.-overview-of-the-general-linear-hypothesis}
...
\paragraph{Show Overhead C Details. Procedure for conducting the general
linear
hypothesis}\label{show-overhead-c-details.-procedure-for-conducting-the-general-linear-hypothesis}
...
\paragraph{Show Overhead D Details. The general linear hypothesis for a
single
variable}\label{show-overhead-d-details.-the-general-linear-hypothesis-for-a-single-variable}
...
\paragraph{Show Overhead A Details. Iterative
approach}\label{show-overhead-a-details.-iterative-approach}
...
\paragraph{Show Overhead B Details. Many possible
models}\label{show-overhead-b-details.-many-possible-models}
...
\paragraph{Show Overhead C Details. Model
validation}\label{show-overhead-c-details.-model-validation}
...
\paragraph{Show Overhead A Details. Classic stepwise regression
algorithm}\label{show-overhead-a-details.-classic-stepwise-regression-algorithm}
...
\paragraph{Show Overhead B Details. Drawbacks of stepwise
regression}\label{show-overhead-b-details.-drawbacks-of-stepwise-regression}
...
\paragraph{Show Overhead C Details. Data-snooping in stepwise
regression}\label{show-overhead-c-details.-data-snooping-in-stepwise-regression}
...
\paragraph{Show Overhead D Details. Variants of stepwise
regression}\label{show-overhead-d-details.-variants-of-stepwise-regression}
...
\paragraph{Show Overhead E Details. Automatic variable selection
procedures}\label{show-overhead-e-details.-automatic-variable-selection-procedures}
...
\paragraph{Show Overhead A Details. Residual
analysis}\label{show-overhead-a-details.-residual-analysis}
...
\paragraph{Show Overhead B Details. Using residuals to select
explanatory
variables}\label{show-overhead-b-details.-using-residuals-to-select-explanatory-variables}
...
\paragraph{Show Overhead C Details. Detecting relationships between
residuals and explanatory
variables}\label{show-overhead-c-details.-detecting-relationships-between-residuals-and-explanatory-variables}
...
\paragraph{Show Overhead A Details. Unusual observationsUnusual
observations}\label{show-overhead-a-details.-unusual-observationsunusual-observations}
...
\paragraph{Show Overhead B Details. Standardized
residuals}\label{show-overhead-b-details.-standardized-residuals}
...
\paragraph{Show Overhead C Details. Outlier - an unusal standardized
residual}\label{show-overhead-c-details.-outlier---an-unusal-standardized-residual}
...
\paragraph{Show Overhead D Details. High leverage
points}\label{show-overhead-d-details.-high-leverage-points}
...
\paragraph{Show Overhead E Details. High leverage point
graph}\label{show-overhead-e-details.-high-leverage-point-graph}
...
\paragraph{Show Overhead F Details.
Leverage}\label{show-overhead-f-details.-leverage}
...
\paragraph{Show Overhead A Details.
Collinearity}\label{show-overhead-a-details.-collinearity}
...
\paragraph{Show Overhead B Details. Quantifying
collinearity}\label{show-overhead-b-details.-quantifying-collinearity}
...
\paragraph{Show Overhead C Details. Options for handling
collinearity}\label{show-overhead-c-details.-options-for-handling-collinearity}
...
\paragraph{Show Overhead A Details. Goodness of
fit}\label{show-overhead-a-details.-goodness-of-fit-1}
...
\paragraph{Show Overhead B Details. Goodness of fit and information
criteria}\label{show-overhead-b-details.-goodness-of-fit-and-information-criteria}
...
\paragraph{Show Overhead C Details. Out of sample
validation}\label{show-overhead-c-details.-out-of-sample-validation}
...
\paragraph{Show Overhead D Details. Out of sample validation
procedure}\label{show-overhead-d-details.-out-of-sample-validation-procedure}
...
\paragraph{Show Overhead E Details. Cross -
validation}\label{show-overhead-e-details.-cross---validation}
...
\paragraph{Show Overhead A Details. MEPS health
expenditures}\label{show-overhead-a-details.-meps-health-expenditures}
...
\paragraph{Show Overhead B Details. Overhead MEPS health
expenditures}\label{show-overhead-b-details.-overhead-meps-health-expenditures}
...
\paragraph{Show Overhead C Details. Outcome
variable}\label{show-overhead-c-details.-outcome-variable}
...
\paragraph{Show Overhead D Details. Explanatory
variables}\label{show-overhead-d-details.-explanatory-variables}
...
\paragraph{Show Overhead E Details. Case study
outline}\label{show-overhead-e-details.-case-study-outline}
...
\paragraph{Show Overhead A Details. Interpreting individual
effects}\label{show-overhead-a-details.-interpreting-individual-effects}
...
\paragraph{Show Overhead B Details. Other
Interpretations}\label{show-overhead-b-details.-other-interpretations}
...
\paragraph{Show Overhead A Details. The importance of variable
selection}\label{show-overhead-a-details.-the-importance-of-variable-selection}
...
\paragraph{Show Overhead B Details. Example. Regression using one
explanatory
variable}\label{show-overhead-b-details.-example.-regression-using-one-explanatory-variable}
...
\paragraph{Show Overhead C Details. Principle of
parsimony}\label{show-overhead-c-details.-principle-of-parsimony}
...
\subsubsection{MC Exercise}\label{mc-exercise}
