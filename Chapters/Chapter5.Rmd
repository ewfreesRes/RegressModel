...
One of the mort important steps in linear regression is understanding your data. Using a combination of `str()` and  `summary()` lets you view quantitative statistics about your data, while `boxplot()` and `hist()` give you a more visual representation of your data.
```
