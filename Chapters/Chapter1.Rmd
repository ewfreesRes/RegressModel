...
ex() %>% check_function("hist",not_called_msg="Use the hist command to create a histogram of the children's heights.") %>% {
  check_arg(., "x") %>% check_equal(incorrect_msg="Make sure to create a histogram of the children's heights.")
...
ex() %>% check_function("quantile") %>% {
  check_arg("probs") %>% check_equal(incorrect_msg="If we want to find the Yth percentile, make sure to set probs equal to Y in decimal format.")
  check_arg(., "x") %>% check_equal()
...
ex() %>% check_function("summary",index=1) %>% check_arg("object") %>% check_equal(incorrect_msg="Make sure to get summary statistics of `injury`.")
ex() %>% chec_function("summary",index=2) %>% check_arg("object") %>% check_equal(incorrect_msg="Make sure to get summary statistics of `injury2`.")
