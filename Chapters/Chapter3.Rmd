...
ex() %>% check_object("pchange_fits1", undefined_msg="Make sure to assign exponential of the differences between the fit values to `pchange_fits1`.") %>% check_equal(incorrect_msg="this should be equal to the exponential of lsfits1[i] – lsfits1[i-1]. ")
